	...
	<div id="main">
		<div id="center" class="panel panel-default">
			...
			<div id="screen">
				...
				<div id=content>
					<div id=functionLeft>
						<label class="labelLeft">Withdraw</label> <label class="labelLeft">Check
							Balance</label> <label class="labelLeft">Transfer</label>
					</div>
					<div id=functionRight>
						<label class="labelRight">View History</label> <label
							class="labelRight">Change PIN</label> <label class="labelRight">Exit</label>
					</div>
				</div>
			</div>
			<div id="right">
